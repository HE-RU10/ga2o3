...
##obtain ws defects sites atoms' position vector and type information
...
for i in success_s:
    ...
    mod=WignerSeitzAnalysisModifier(per_type_occupancies = True, output_displaced=True)
    ...
    particles['site_type']=data.particles['Site Type']
    particles['site_identify']=data.particles['Site Identifier']
    particles.to_csv('Idefects_displaced_position{}.csv'.format(i)) 
