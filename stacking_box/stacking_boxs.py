...
update for ga2o3 project Feb 29 2024
@author: Ru He
"""
...
def connect(path2CellList, path2Base, prog, deltaZ, lmp_time, \
    ...
    path2CellList: path to the folder of cell
    ...
    cellList = getCellList(path2CellList, character = '*.xyz')
    prog = path2Base + prog
    ...
    for i in range(0, len(cellList)):
        dump1, tmp_x, tmp_y, tmp_z, dump2, dump3 = readcells(cellList[i])
        x_list.append(tmp_x)
        y_list.append(tmp_y)
